...
def evaluate_ratings(own_rating, external_rating):
...
if __name__ == "__main__":
    ...
    ai_answers_rating = get_answers(config.get_ai_answers_to_rate_path())
    man_answers_rating = get_answers(config.get_man_answers_to_rate_path())

    ai_answers_training = get_answers(config.get_ai_answers_for_training_path())
    man_answers_training = get_answers(config.get_man_answers_for_training_path())
